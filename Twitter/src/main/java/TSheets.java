...
public class TSheets extends CommonAPI {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = TSheets.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
    ...
    public void clickTopNavBar() throws IOException, InterruptedException, GeneralSecurityException {
        TestLogger.log(getClass().getSimpleName() + ": " + CommonAPI.convertToString(new Object() {
        }.getClass().getEnclosingMethod().getName()));
        List<String> list = getDataFromGSheet("TTopBar");
    ...
    public void searchPeople() throws Exception {
        ...
        Thread.sleep(500);
        tSearch.clear();
        List<String> list = getDataFromGSheet("Friends");
    ...
    public void searchPhoto() throws Exception {
        ...
        Thread.sleep(500);
        tSearch.clear();
        List<String> list = getDataFromGSheet("Items");
        for (String name : list) {
            TestLogger.log(getClass().getSimpleName() + ": " + CommonAPI.convertToString(new Object() {
            }.getClass().getEnclosingMethod().getName()) + ", " + name);
            tSearch.sendKeys(name, Keys.ENTER);
